...
| claude | [`claude.py`](../scripts/alltokenmon/adapters/claude.py) | JSONL | P39 + OS | [`session.jsonl`](../tests/fixtures/.claude/projects/safe/session.jsonl) | [`test_claude.py`](../tests/adapters/test_claude.py) | [`test_claude.py`](../tests/adapters/test_claude.py) | PR39 | AG39 | complete |
